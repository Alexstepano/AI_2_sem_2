# AI_2_sem_2 -  Proof-of-concept прототип, иллюстрирующий применимость LLM к распознаванию спама и анализ перформонса модели при применении техник промтинга
